-- Clean Reset Migration - Drop and Recreate All Tables
...
DROP TRIGGER IF EXISTS update_equipped_items_updated_at ON equipped_items;
DROP TRIGGER IF EXISTS update_equipped_customizations_updated_at ON equipped_customizations;
DROP TRIGGER IF EXISTS update_personal_bests_updated_at ON personal_bests;
...
DROP TABLE IF EXISTS equipped_customizations CASCADE;
DROP TABLE IF EXISTS equipped_items CASCADE;
